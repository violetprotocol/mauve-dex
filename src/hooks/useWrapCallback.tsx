...
Please file a bug detailing how this happened - https://github.com/violetprotocol/mauve-dex/issues/new?labels=bug&template=bug-report.md&title=Invalid%20WETH%20contract`)
                    setError(error)
                    throw error
                  }
