...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.mauve.org', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.mauve.org', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.mauve.org', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.mauve.org', pathname: '/asset.gif' } }, false],
