...
// TODO change these to use mauve
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.mauve.org/#/optimism/',
    label: 'Optimism',
    logoUrl: optimismLogoUrl,
    // Optimism perfers same icon for both
    circleLogoUrl: optimismLogoUrl,
    statusPage: 'https://optimism.io/status',
    helpCenterUrl: 'https://docs.mauve.org',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
    color: lightTheme.chain_10,
    backgroundColor: lightTheme.chain_10_background,
  },
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.mauve.org/#/arbitrum',
    label: 'Arbitrum',
    logoUrl: arbitrumLogoUrl,
    circleLogoUrl: arbitrumCircleLogoUrl,
    defaultListUrl: ARBITRUM_LIST,
    helpCenterUrl: 'https://info.mauve.org',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
    color: lightTheme.chain_42,
    backgroundColor: lightTheme.chain_42161_background,
  },
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://info.mauve.org/#/polygon/',
    label: 'Polygon',
    logoUrl: polygonMaticLogo,
    circleLogoUrl: polygonCircleLogoUrl,
    nativeCurrency: { name: 'Polygon Matic', symbol: 'MATIC', decimals: 18 },
    color: lightTheme.chain_137,
    backgroundColor: lightTheme.chain_137_background,
  },
  ...
  [SupportedChainId.CELO]: {
    ...
    infoLink: 'https://info.mauve.org/#/celo',
    label: 'Celo',
    logoUrl: celoLogo,
