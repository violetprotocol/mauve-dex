import { BigintIsh, CurrencyAmount, Token, TradeType } from '@violetprotocol/mauve-sdk-core'
// This file is lazy-loaded, so the import of smart-order-router is intentional.
// eslint-disable-next-line no-restricted-imports
import { AlphaRouter, AlphaRouterConfig, ChainId } from '@violetprotocol/mauve-smart-order-router'
